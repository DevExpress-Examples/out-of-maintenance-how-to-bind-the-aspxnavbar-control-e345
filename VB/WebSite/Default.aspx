...
<%@ Page Language="vb" AutoEventWireup="true" CodeFile="Default.aspx.vb" Inherits="ASPxperience_NavBar_Binding_Binding" %>

<%@ Register Assembly="DevExpress.Web.v13.1" Namespace="DevExpress.Web.ASPxNavBar" TagPrefix="dxnb" %>
<%-- EndRegion --%>
		...
		<dxnb:ASPxNavBar ID="nbNavBar" runat="server" DataSourceID="XmlDataSource1" Width="250px">
			<GroupHeaderTemplate>
				<strong style="color: #F82F61;">
					<%#IIf((Not String.IsNullOrEmpty(Container.Group.Name)), Container.Group.Name, Container.Group.Text)%>
				</strong>
			</GroupHeaderTemplate>
			<ItemTemplate>
